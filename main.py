...
print("Hello , Welcome To Gamecooler19's Gift Code Generator")
time.sleep(1)
print("This Script Is Just for educational prupose use it at your own risk")
time.sleep(1)
total = input("How Many Gift Codes Would You Like To Generate ?  :-  ")
number = int(total)
file = 'Minecraft.txt'
file2 = "Amazon.txt"
file3 = "iTunes.txt"
file4 = "Paypal.txt"
file5 = "PlayStation.txt"
file6 = "Steam.txt"
file7 = "Visa.txt"
file9 = "Xbox.txt"
file10 = "PlayStore.txt"
file11 = "PokemonTGC.txt"
file12 = "Netflix.txt"
file13 = "Ebay.txt"
file14 = "Fortnite.txt"
file15 = "Roblox.txt"
...
if(mode == "Minecraft"):
    for x in range(number):
        ...
        with open(file, 'a') as out:
          out.write()
#Amazon
if(mode == "Amazon"):
    for x in range(number):
        generate1 = random.choice(gentype)
...
print ("Thanks For Using Gamecooler19's Gift Code Generator")
time.sleep(5)
